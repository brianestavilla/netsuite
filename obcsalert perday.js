function suitelet(request, response){
		if ( request.getMethod() == 'GET' ){
			...
			var perdate =  form.addField('custpage_perdate','date', 'Date : ');
			var period = form.addField('custpage_selectperiod','select', 'Posting Period : ');
		...
		}else
		{
			...
			if(context.getSessionObject('status') == 'get'){
				var trandates = request.getParameter('custpage_perdate'),
				princ = request.getParameter('custpage_selectprincipal'),
				...
				var docdate = form.addField('custpage_trandate','date', 'Transaction Date: ').setDisplayType('inline');
				docdate.setDefaultValue(trandates);
				...
				var filteractual = [
						...
						new nlobjSearchFilter('trandate', null, 'on', trandates)
					];
				var columnactual = [
