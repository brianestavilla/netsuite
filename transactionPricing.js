...
function validateLine(){	
	var d1 = parseFloat(nlapiGetCurrentLineItemValue(ITEM_SUBLIST, DISC1))/100,
		...
		amount = parseFloat(nlapiGetCurrentLineItemValue(ITEM_SUBLIST, GROSS_AMT)),
	...
	if(discount != null)
	{
		...
		if(itemPricing != null)
		{
			...
			if(condition){
				...
				var gross = (nlapiGetCurrentLineItemValue(ITEM_SUBLIST, GROSS_AMT) == '' || nlapiGetCurrentLineItemValue(ITEM_SUBLIST, GROSS_AMT) == null) ? 0 : nlapiGetCurrentLineItemValue(ITEM_SUBLIST, GROSS_AMT);
